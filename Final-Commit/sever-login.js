...
app.post("/register", async (request, response) => {
   ...
   /* app.post("/emailresetpass", async (request, response) => {
        ...
        try {
            ...
            link="http://"+request.post('host')+"/verify?id="+rand;
            mailOptions={
                to : request.body.email,
    ...
    try {
        ...
        UserModel.findOne({email: request.body.email}, function(err, user){
            ...
            user.save(function(err){
             ...
             response.cookie('ad-block-email', 'request.body.email',{httpOnly: false }); //Sets name = express
             console.log(request.cookies['ad-block-email'])
           // response.cookie('ad-block-login', 'user.loggedin', {httpOnly: false });
...
app.post("/logout", async (request, response) => {
    UserModel.findOne({password: request.body.password}, function(err, user){
        if(err)return ("err");
        user.loggedin = false;
